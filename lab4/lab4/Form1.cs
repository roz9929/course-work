...
namespace lab4
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows.Add(worker[cout].FIO, worker[cout].Post, worker[cout].Date_of_Birth, worker[cout].Degree, worker[cout].Experience.ToString());
            cout++;
        }
            ...
            if (radioButton1.Checked == true)
            {
                ...
                foreach (Employee wSel in worker)
                {
                    if (wSel.Experience >= select1)
                        dataGridView2.Rows.Add(wSel.FIO, wSel.Post, wSel.Date_of_Birth, wSel.Degree, wSel.Experience.ToString());
                }
            }
